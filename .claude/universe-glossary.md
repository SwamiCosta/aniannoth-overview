# Keynor Universe — Glossary
# Maintained by: Aniannoth (Level 3 Architect)
# Scope: shared reference for all agents in aniannoth-overview

> This glossary defines words and terms native to the Keynor universe.
> All agents must read this file before producing any text, data, or UI content
> that references universe-specific language.
>
> Terms are listed alphabetically. Each entry includes the canonical spelling,
> English equivalent where applicable, definition, usage rules, and etymology.
...
### valkani
**English equivalent:** valkani (no translation — the word is used as-is in English text)
**Meaning:** individual, person, people

`valkani` refers to one or more persons regardless of race, gender, or origin. It is both singular and plural — the word does not change form.
...
- Non-conscious or non-mortal beings of any kind
